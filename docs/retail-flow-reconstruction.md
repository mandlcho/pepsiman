...
State 5 starts the shared retail result effect with `0x8003e444` and polls `0x8003e544` until it completes. The actually dispatched result updater is `0x8003cc94`. Its initial state reveals the background at frame 0, starts a secondary effect at frame 24, enables the first scorecard at frame 40, enables the second at frame 64, settles it at frame 68, and begins the Pepsi-count phase at frame 80. These are executable-derived frame boundaries, not timings estimated from video.
