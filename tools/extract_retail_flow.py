    ...
    for scene_index in range(SCENE_COUNT):
        ...
        if scene_index == 0:
            ...
            ending.update({
                ...
                "cameraAdvanceCounterFrames": 41,
                "cameraTarget": {
                    "constructionAddress": "0x800f8194",
                    "interpolationAddress": "0x800f8274",
                    "eyeHeadingOffsetPsx": 0x71D,
                    "eyeRadius": 200,
                    "eyeVerticalOffset": -280,
                    "lookHeadingOffsetPsx": 0x800,
                    "lookRadius": 50,
                    "lookVerticalOffset": -130,
                    "psxAngleUnitsPerTurn": 4096,
                    "browserCoordinateApplicationInferred": True,
                },
